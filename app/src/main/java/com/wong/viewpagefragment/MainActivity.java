...
public class MainActivity extends AppCompatActivity {
    ...
    private void findView() {
        ...
        mContainer = (RelativeLayout) findViewById(R.id.rlContainer);
    }
    ...
    private void setCurrentPage(int position) {
        ...
        switch (position) {
            case 0:
                transaction.replace(R.id.rlContainer, ViewPagerFragment.getInstance(ViewPagerFragment.TYPE_0));
                transaction.commit();
                break;
            case 1:
                transaction.replace(R.id.rlContainer, ViewPagerFragment.getInstance(ViewPagerFragment.TYPE_1));
                transaction.commit();
                break;
        }
    }
